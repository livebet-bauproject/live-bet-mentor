        ...
        <div style={{
            ...
            <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '1.5rem' }}>
                    ...
                    <div>
                        <div style={{
                            ...
                            {t.legal_modal_badge || (lang === 'tr' ? '🔞 18+ YASAL BİLGİLENDİRME & KULLANIM SÖZLEŞMESİ' : '🔞 18+ STATUTORY DISCLOSURE & TERMS OF USE')}
                        </div>
                        <h2 style={{ fontSize: '1.35rem', fontWeight: 900, color: '#f8fafc', margin: 0 }}>
                            {t.legal_modal_title || (lang === 'tr' ? 'Hukuki Şartlar & Sorumluluk Reddi' : 'Legal Terms & Disclaimer')}
                        </h2>
                    </div>
                </div>
                ...
                <div style={{ fontSize: '0.85rem', lineHeight: 1.7, color: '#94a3b8', display: 'flex', flexDirection: 'column', gap: '1.2rem' }}>
                    ...
                    <div style={{ background: 'rgba(255, 255, 255, 0.03)', padding: '1rem', borderRadius: '12px', border: '1px solid rgba(255, 255, 255, 0.06)' }}>
                        <h4 style={{ color: '#38bdf8', fontWeight: 800, fontSize: '0.9rem', marginBottom: '0.4rem' }}>
                            {t.legal_section1_title || (lang === 'tr' ? '1. Platformun Niteliği (Bahis Oynatılmaz)' : '1. Nature of the Platform (No Gambling Conducted)')}
                        </h4>
                        <p style={{ margin: 0 }}>
                    ...
                    <div style={{ background: 'rgba(255, 255, 255, 0.03)', padding: '1rem', borderRadius: '12px', border: '1px solid rgba(255, 255, 255, 0.06)' }}>
                        <h4 style={{ color: '#fbbf24', fontWeight: 800, fontSize: '0.9rem', marginBottom: '0.4rem' }}>
                            {t.legal_section2_title || (lang === 'tr' ? '2. 7258 Sayılı Kanun ve Yasal Uyum Beyanı' : '2. Statutory & Regulatory Compliance Statement')}
                        </h4>
                        <p style={{ margin: 0 }}>
                    ...
                    <div style={{ background: 'rgba(255, 255, 255, 0.03)', padding: '1rem', borderRadius: '12px', border: '1px solid rgba(255, 255, 255, 0.06)' }}>
                        <h4 style={{ color: '#f43f5e', fontWeight: 800, fontSize: '0.9rem', marginBottom: '0.4rem' }}>
                            {t.legal_section3_title || (lang === 'tr' ? '3. Kesin Kazanç Garantisi Yoktur (İstatistiki Çıktı)' : '3. No Guarantee of Profit (Statistical Outputs)')}
                        </h4>
                        <p style={{ margin: 0 }}>
                    ...
                    <div style={{ background: 'rgba(255, 255, 255, 0.03)', padding: '1rem', borderRadius: '12px', border: '1px solid rgba(255, 255, 255, 0.06)' }}>
                        <h4 style={{ color: '#a78bfa', fontWeight: 800, fontSize: '0.9rem', marginBottom: '0.4rem' }}>
                            {t.legal_section4_title || (lang === 'tr' ? '4. 18+ Yaş Sınırı ve Kullanıcı Sorumluluğu' : '4. 18+ Age Restriction & User Responsibility')}
                        </h4>
                        <p style={{ margin: 0 }}>
                    ...
                    <div style={{ background: 'rgba(255, 255, 255, 0.03)', padding: '1rem', borderRadius: '12px', border: '1px solid rgba(255, 255, 255, 0.06)' }}>
                        <h4 style={{ color: '#10b981', fontWeight: 800, fontSize: '0.9rem', marginBottom: '0.4rem' }}>
                            {t.legal_section5_title || (lang === 'tr' ? '5. Üyelik ve Lisans Bedeli Tanımı' : '5. Membership & Software License Definition')}
                        </h4>
                        <p style={{ margin: 0 }}>
                ...
                <div style={{ marginTop: '2rem', textAlign: 'center' }}>
                    ...
                    >
                        {t.legal_modal_close || (lang === 'tr' ? 'Anladım ve Kabul Ediyorum' : 'I Understand and Agree')}
                    </button>
                </div>
            </div>
        </div>
